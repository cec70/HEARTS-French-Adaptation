...
Alongside the French adaptation, this repository includes the notebook `HEARTS_EMGSD_ALBERT.ipynb`, which replicates one of the experiments from the original HEARTS paper using the ALBERT-base-v2 model and the EMGSD dataset. This replication follows the project's requirement of reproducing the baseline AI methodology using the open dataset. The model achieves a macro-F1 score of **81.14%**, closely matching the 81.5% reported in the paper.
